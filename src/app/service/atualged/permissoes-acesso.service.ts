...
export class PermissoesAcessoService {
  ...
  public pesquisarPermissoes(value: string) {
    return this.http.post(
      this.as.url + this.url + "/pesquisarpermissoes",
      value,
      this.as.getOptions()
    );
  }
  ...
  public pesquisar(value: string) {
    return this.http.post(
      this.as.url + this.url + "/pesquisarperfilusuario",
      value,
      this.as.getOptions()
    );
  }
  ...
  public salvarPerfilUsuario(value: PerfilUsuario) {
    return this.http.post(
      this.as.url + this.url + "/salvarperfilusuario",
      value,
      this.as.getOptions()
    );
  }
  ...
  public deletarPerfilUsuario(value: PerfilUsuario) {
    return this.http.post(
      this.as.url + this.url + "/excluirperfilusuario",
      value,
      this.as.getOptions()
    );
  }
