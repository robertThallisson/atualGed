...
export class EscritorioInserirPage implements OnInit {
  ...
  escritorio: Escritorio = new Escritorio(); 
   ...
   ngOnInit() {
     if ((this.escritorioService.escritorio !== undefined) && (this.escritorioService.escritorio !== null)) {
   ...
   salvar() {
     ...
     this.escritorioService.salvar(this.escritorio).subscribe(
       data => {
         ...
         this.base.dismiss();
         this.base.mensagemErro('Falha ao salvar este escritorio :' + this.base.tratarErro(error));
       }
     ); 
   }
